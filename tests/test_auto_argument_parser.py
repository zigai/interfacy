...
def test_from_function():
    ...
    auto_parser = AutoArgparseParser(desciption=func.description)
...
def test_from_method():
    ...
    auto_parser = AutoArgparseParser(desciption=method.description)
    parser = auto_parser.parser_from_method(method)
