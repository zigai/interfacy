...
napoleon_type_aliases = {
    ...
    "Function": "``Function``",
    "HelpLayout": ":class:`interfacy.help.HelpLayout`",
    "HelpOptionSortRule": ":data:`interfacy.schema.sorting.HelpOptionSortRule`",
    "HelpSubcommandSortRule": ":data:`interfacy.schema.sorting.HelpSubcommandSortRule`",
    ...
    "InterfacyColors": ":class:`interfacy.help.InterfacyColors`",
    "Method": "``Method``",
    "Parameter": "``Parameter``",
...
autodoc_type_aliases = {
    ...
    "HelpLayout": "interfacy.help.HelpLayout",
    "HelpOptionSortRule": "interfacy.schema.sorting.HelpOptionSortRule",
    "HelpSubcommandSortRule": "interfacy.schema.sorting.HelpSubcommandSortRule",
    ...
    "InterfacyColors": "interfacy.help.InterfacyColors",
    ...
    "interfacy.help.layout.InterfacyColors": "interfacy.help.InterfacyColors",
    "interfacy.schema.sorting.HelpOptionSortRule": "interfacy.schema.sorting.HelpOptionSortRule",
    "interfacy.schema.sorting.HelpSubcommandSortRule": "interfacy.schema.sorting.HelpSubcommandSortRule",
    "interfacy.help.layouts.HelpLayout": "interfacy.help.HelpLayout",
}
...
nitpick_ignore = [
    ("py:class", "'interfacy.schema.sorting.HelpOptionSortRule'"),
    ("py:class", "'interfacy.schema.sorting.HelpSubcommandSortRule'"),
    ...
    ("py:class", "interfacy.schema.sorting.T"),
